...
export const jwtStrategy = new JWTStrategy(jwtStrategyOptions, (payload: Partial<IUser>, done) => {
...
export const generateToken = (user: Partial<IUser>): string => jwt.sign(user, jwtSecret)